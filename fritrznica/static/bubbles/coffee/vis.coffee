...
texts = [
  ...
  {key:"aesop",file:"data.csv",name:"Aesop's Fables"}
  {key:"alice",file:"data.csv",name:"Alice's Adventures in Wonderland"}
  {key:"gulliver",file:"data.csv",name:"Gulliver's Travels"}
]
...
$ ->
  ...
  # load our data
  d3.csv("../static/bubbles/data/data.csv", display)
