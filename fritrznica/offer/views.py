    ...
    if not request.user.is_active:
        ...
        if id < 0:
            ...
            if Offers.objects.filter(id=id).exists():
                ...
                off1=Offers(id=id, user_id=off.user_id, termin=off.termin, ucilnica=off.ucilnica, predmet=off.predmet, version=off.version, offered=True, closed=False, swap_id=-1)
                off1.save()
